...
In-line measurements of aluminium profile 	
...
(waiel.elmadih@taraz.uk) 

3D runout characterisation 	
...
WP3	TTTech 	Francesca Flamigni 
(francesca.flamigni@tttech.com) 


Edge-based Data Profiling and Repair as a Service 	
...
WP4	KIT-AR / SkillAugment 	Felix Mannhardt (felix.mannhardt@kit-ar.com) 
...
WP4	SINTEF Digital	Erik Johannes Husom 
(erik.johannes.husom@sintef.no) 


Machine Learning to predict Product Quality based on Structure Bourne Sound Data 	
...
https://bwsyncandshare.kit.edu/s/FKxj2KMWeDWqoEF 	WP4	KIT	Ali Bilen (ali.bilen@kit.de) 


XAI Quality Analytics Module 	
...
WP4	IdleTechs 	Torbjørn Pedersen
(torbjorn.pedersen@idletechs.com)


Grinding defects prediction toolkit 	
...
WP5	Ideko	Jorge Alvarez Ruiz 
(j.alvarez@ideko.es) 


Developed supplier selection process 	
...
WP5	KIT	Rainer Silbernagel (rainer.silbernagel@kit.de) 
...
(frank.westad@idletechs.no) 


Tool Demo: REPTILE-a Tool for Replay-driven Continual Learning in IIoT 	
...
https://www.youtube.com/watch?v=MhSnwPDnAh0 	WP6	SINTEF Digital	Erik Johannes Husom 
(erik.johannes.husom@sintef.no)
